...
PARTICIÓN DE EQUIVALENCIA - RF-02: CÓDIGO DE ESTUDIANTE
...
+-----------------------------+------------------------------------------+---------------------------------------------------
| Caracteres restantes        | V3: Los 7 caracteres siguientes son      | I6: Contiene al menos una letra en los 7 caracteres        |
|                             |     numéricos                            | I7: Contiene al menos un carácter especial en los 7 carac. |
